    ...
    <div class = "card">
        <div class = "inner-box" id="card">
            <form action="ControllerServlet" method="post">
                <h2>Delete Course</h2>
                <h3>${message}</h3>
                <input type = "text" class = "input-box" placeholder="Name of Course to Delete" name = "Course" required></br>
                <button type="submit" class="submit-btn" name = "action" value="DeleteCourseinDB">Submit</button>
            </form>
